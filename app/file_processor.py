...
class FileProcessor:
    ...
    def copy_metadata(self, source_metadata: str, base_dir: str):
        ...
        if not self._should_process(source_metadata, dest_metadata):
